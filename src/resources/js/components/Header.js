...
function Header(props) {
    ...
    return <header className="navbar navbar-light sticky-top bg-white flex-md-nowrap p-0 shadow-sm">
        <a className="navbar-brand header-brand col-md-3 col-lg-2 me-0 px-3 p-3" href="https://paxful.com">
            <svg viewBox="0 0 123.7 23.3" xmlns="http://www.w3.org/2000/svg"
                 className="header-logo" fill="currentColor">
                <path
                ...
                ></path>
                <path d="m63.1 0-21.6 23.2c-.2.3-.7-.1-.4-.4l15.6-22c.4-.5 1-.8 1.7-.8z" fill="#00a5ef"></path>
            </svg>
        </a>
